...
app.post("/sms", (req, res) => {
  ...
  if (req.body.Body.trim().toLowerCase() == "ready") {
    ...
    twiml.message(
      'Your vehicle will be ready for pickup within 5 minutes. If you need more time simply reply "Wait". You will receive a text notification once your vehicle is ready for pickup.'
    );
    ...
    twiml.message(
      'No worries! Please reply "Ready" to this message again when ever you are ready to pick up your car. Thank you! 😊'
    );
  } else {
    twiml.message(
