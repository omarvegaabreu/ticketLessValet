    ...
    return (
      <div className="container homeBox">
        ...
        <div className="row text-center justify-content-center">
          <img
            className="my-3 center-block"
            alt="homelogo"
            src="./assets/images/ez-valet-logo3.jpg"
            width="270px"
            height="250px"
          />
        </div>
        <div className="row text-center justify-content-center my-2">
          <h5 className="text-center text-primary mx-2 p-2 font-weight-bold">
            Fully Ticketless Valet Solution
          </h5>
        </div>
