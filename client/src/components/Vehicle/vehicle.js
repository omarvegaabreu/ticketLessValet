...
class Vehicle extends Component {
  ...
  handleInput = (event) => {
    ...
    this.setState({
      customerId:
        "EZ-" +
        this.state.pocphone.substring(this.state.pocphone.length - 2) +
        randomNumber,
    });
  };
  handleUpload = (event) => {
    ...
    if (
      ...
      API.saveVehicle({
        ...
        mediaUrl:
          "https://chart.googleapis.com/chart?chs=350x350&cht=qr&chl=" +
          encodeURIComponent(qrStrData) +
          "&choe=UTF-8",
        rate: this.state.rate,
        total: this.state.total,
      })
        .then((res) => {
          this.loadVehicles().then(() => window.location.reload());
        })
        .catch((err) => console.log(err));
    }
  };
            ...
            <div className="dashboardBox bgimg">
              {this.state.loggedIn ? (
                <div className="profileBox bgimg">
                  <h3 className="aqua-gradient text-white p-2" id="userTitle">
                  ...
                  <div>
                    <Row>
                      <Col className="lg-4">
                        ...
                        <Form>
                          ...
                          <FormGroup>
                            <Label htmlFor="poc">Owner Name</Label>
                            <Input
                              type="text"
                              name="poc"
                              id="poc"
                          ...
                          <FormGroup>
                            ...
                            <Input
                              ...
                              name="vehicleinfo"
                              id="vehicleinfo"
                              placeholder="Make-Model-Year-Color-Plate# etc."
                              onChange={(event) => this.handleInput(event)}
                            />
                          </FormGroup>
                          <FormGroup>
                            <Label htmlFor="spaces">Parking Space</Label>
                            <Input
                              type="text"
                              name="spaces"
                              id="spaces"
                              placeholder="Enter the parking space number"
                              onChange={(event) => this.handleInput(event)}
                            />
                          </FormGroup>
                    ...
                    <Row>
                      <Col>
                        <h2 className="bg-dark text-white mt-1 p-2 text-center">
                          Parked Vehicles
                        </h2>
                      </Col>
                    </Row>
                      ...
                      <Col className="lg-4">
                        <div>
                          <FormGroup className="form-inline my-4">
                            <div className="form-group mr-2">
                              ...
                              <select
                                id="dropdown_change"
                                className="custom-select form-group col-md-8 mx-2"
                                name="selectBy"
                              >
                        ...
                        {this.state.vehicles.length ? (
                          <div className="table-responsive-sm">
                            <table
                              id="myTable"
                              className="table table-bordered w-auto table-sm"
                              cellSpacing="0"
                              width="100%"
                              style={{ marginTop: 20 }}
                            >
                  ...
                  {!this.state.loading ? (
                    <>
                      ...
                      <Link className="loginLink" to="/login">
                        <Button className="loginBtn" color=".bg-success" block>
                          Login
                        </Button>
                      </Link>
